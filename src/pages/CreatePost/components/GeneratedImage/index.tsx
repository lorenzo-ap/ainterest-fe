...
const GeneratedImage = ({
  ...
  return (
    ...
    >
      <div
        className={`${styles.backgroundColor} relative rounded-xl border ${isImageMissing ? 'border-[#FA5252]' : styles.border} flex aspect-square items-center justify-center shadow-lg transition-colors`}
      >
        {imageSource ? (
